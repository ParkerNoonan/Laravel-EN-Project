	...
	<div id="overall_container">
		...
		<div id="form_sheet" class="container">
			<div class="grid-container1">
				...
				<div class="Doc_Num">Document Number: <input style="font-size: 1.5em; width: 80px;" type="text" name="doc_num" form="final_sub" ></div>
				<div class="Proj_Name">Project Name: <input style="font-size: 1.5em; width: 80px;" type="text" name="proj_name" form="final_sub" ></div>
				<div class="Location">Location: <input style="font-size: 1.5em; height: 10px;" type="text" name="location" form="final_sub" ></div>
				...
				<div class="Rev">Rev <input style="width: 15px; font-size: 10px;" type="text" name="rev" form="final_sub"></div>
				<div class="Date">Date <input style="width: 55px; font-size: 10px;" type="text" name="date" form="final_sub" ></div>
				<div class="Issued_For">Issued For <input style="width: 80px; font-size: 10px;" type="text" name="service" form="final_sub" ></div>
			...
			<div class="grid-container3">
				...
				<div class="column9">Power Gas, </div>
				...
				<div class="column3" style="padding-top: 0px;"><input style="font-size: 7px; height: 5px; text-align: center;" type="text" name="valve_tag" ></div>
				...
				<div class="column3" style="padding-top: 0px;"><input style="font-size: 7px; height: 5px; text-align: center;" type="text" name="valve_man" ></div>
				...
				<div class="column5">Supply Relief Valves</div>
				<div class="column9">UCI-CV4 - psig</div>
...
<script type="text/javascript" src="<?php echo e(asset('js/Act_Data_Sheet_js.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Homestead\ENProject\resources\views/Act_Data_Sheet.blade.php ENDPATH**/ ?>